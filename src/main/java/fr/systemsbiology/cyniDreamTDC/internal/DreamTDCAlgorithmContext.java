/*
  File: DreamTDCAlgorithmContext.java
...
public class DreamTDCAlgorithmContext extends CyniAlgorithmContext implements TunableValidator {
	...
	public static String TWO_DIMENSIONS_FORMAT = "Inhibitor/Time";
	public static String THREE_DIMENSIONS_FORMAT = "Network/Inhibitor/Time";
